...
module.exports = {
    ...
    MENU_IMAGE_URL: process.env.MENU_IMAGE_URL || "https://files.catbox.moe/nxzaly.jpg",
    // add custom menu and mention reply image url

    ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/nxzaly.jpg",
...
`*Hᴇʟʟᴏ ᴛʜᴇʀᴇ DAVE-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ! 👋🏻* 

*ᴋᴇᴇᴘ ᴏɴ ᴜsɪɴɢ DAVE-MD 🚩* 
